...
class SeedsUnitTests(CensysAsmTestCase):
    ...
    def test_get_seeds_by_type(self, mock):
        ...
        mock.assert_called_with(SEEDS_URL, params={'type': TEST_SEED_TYPE}, timeout=TEST_TIMEOUT)
    ...
    def test_get_seed_by_id(self, mock):
        ...
        mock.assert_called_with(f'{SEEDS_URL}/{TEST_SEED_ID}', params={}, timeout=TEST_TIMEOUT)
    ...
    def test_add_seed(self, mock):
        ...
        mock.assert_called_with(
            SEEDS_URL, params={'force': False}, timeout=TEST_TIMEOUT, data=json.dumps({'seeds': [TEST_SEED]})
        )
    ...
    def test_add_seeds(self, mock):
        ...
        mock.assert_called_with(
            SEEDS_URL, params={'force': False}, timeout=TEST_TIMEOUT, data=json.dumps({'seeds': TEST_SEED_LIST})
        )
    ...
    def test_add_seeds_forced(self, mock):
        ...
        mock.assert_called_with(
            SEEDS_URL, params={'force': True}, timeout=TEST_TIMEOUT, data=json.dumps({'seeds': TEST_SEED_LIST})
        )
    ...
    def test_delete_seeds_by_label(self, mock):
        ...
        mock.assert_called_with(SEEDS_URL, params={'label': TEST_SEED_LABEL}, timeout=TEST_TIMEOUT)
