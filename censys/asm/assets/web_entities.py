...
class WebEntitiesAssets(Assets):
    ...
    def get_web_entity(self, name_and_port: str) -> dict:
        """Requests web entity data by name and port.

        Args:
            name_and_port (str): Requested web entity name and port.

        Returns:
            dict: Web entity search result.
        """
        return self.get_asset_by_id(name_and_port)

    def get_web_entity_instances(
        self,
        name_and_port: str,
